...
excerpt: "PI: Dr. Nir Gov @Weizmann Institute of Science, Israel
<br/>
<br/>
Simulating active matter models of midge swarms using a modified gravitational potential to model acoustic interactions to verify if the model can better reproduce the core dynamics of the swarms
